  ...
  return (
    <>
      ...
      <div className="w-full h-[100vh] py-8 relative " >
        <div className='absolute left-[50%] translate-x-[-50%] -top-[2rem] md:-top-[6rem] size-[3rem] md:size-[14rem] rounded-full bg-gradient-to-t from-yellow-400 to-yellow-700 blur-[8em]'>
        </div>
        <div className=" max-w-[1080px]  px-8 mx-auto">
          ...
          <div className="my-20 z-0 flex flex-col h-fit  items-center justify-center">
            ...
            <div className="flex flex-col gap-6 h-fit  items-center justify-center">
              ...
              <div className="text-3xl font-secondary font-[900] sm:text-5xl w-fit md:w-[80%] text-center z-20 justify-center items-center">
                Showcase your open source contributions as <span className="transition-all duration-200 bg-clip-text text-transparent bg-gradient-to-r from-yellow-500 to-yellow-200 w-fit h-fit">Proof of Work</span>
              </div>

              <div className=" text-center font-paragraph md:w-[60%]">
            ...
            <div className="flex items-center gap-4">
              <Button className="font-bold h-10">Explore the arena</Button>
              <Button variant={'outline'} className="font-bold border-[3px] border-primary hover:bg-primary/10 h-10">What's more ?</Button>
            </div>
          </div>
          ...
          <section className="flex items-center justify-center">
            ...
            <div
              className="relative flex items-center justify-center w-64 h-64 rounded-3xl bg-gradient-to-br from-yellow-400 to-yellow-600 shadow-lg overflow-hidden"
              style={{
            ...
            >
              <div className="borer-2 px-4 py-4 w-fit rounded-3xl">
                <GitMerge className="w-44 text-black h-44" />
              </div>
