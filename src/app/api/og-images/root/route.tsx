      ...
      <div tw=" bg-white w-full p-4 h-full flex items-center justify-center flex-col">
        <div tw="flex mt-4 justify-center w-full">
          <div
            ...
            tw="font-bold text-2xl flex items-center"
          >
        ...
        <div tw="mt-8 flex flex-col items-center justify-center w-full">
          <div
            style={{ fontFamily: 'main' }}
            tw="text-6xl w-[70%] flex flex-col items-center font-bold text-center"
          >
            Showcase your open source contributions as your{' '}
            <span tw="text-yellow-400">Proof of Work</span>
          </div>
          <div
            style={{ fontFamily: 'secondary' }}
            tw="w-[50%] text-center mt-6"
          >
        ...
        <div tw="mt-8 flex max-w-7xl mx-auto">
          <div tw="border bg-yellow-500/50 border-[#fff] h-[4rem] flex items-center justify-center shadow-xl border-black w-[30%] rounded-full p-2 ml-4">
            <svg
